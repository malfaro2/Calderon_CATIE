...
#Load data
#Rasgos funcionales
deff_redun_sp <- read.csv("C:/tesis_catie/Calderon_CATIE/data/clean/deff_clean_sin_palmas.csv",header = T)
deff_redun_sp <- deff_redun_sp %>% dplyr::select(-c(familia, especie)) %>% column_to_rownames("coespec")
