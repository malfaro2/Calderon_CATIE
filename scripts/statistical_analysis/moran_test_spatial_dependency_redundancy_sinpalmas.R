...
# Cargar datos ------------------------------------------------------------
data_redundancy_sinpalmas <- read.csv("data/resultados_csv/data_redundancy_sinpalmas.csv",header=T)
...
redundancy_dists_sp <- as.matrix(dist(cbind(data_redundancy_sinpalmas$longitude, 
                                         data_redundancy_sinpalmas$latitude)))

redundancy_dists_inv_sp <- 1/redundancy_dists_sp

diag(redundancy_dists_inv_sp) <- 0

#La matriz debe quedar con 0s en la diagonal
redundancy_dists_inv_sp[1:5, 1:5]
...
Moran.I(data_redundancy_sinpalmas$redundancy, redundancy_dists_inv_sp)

#Uniqueness sin palmas
Moran.I(data_redundancy_sinpalmas$U,  redundancy_dists_inv_sp)

#Rao sin palmas
Moran.I(data_redundancy_sinpalmas$Q,  redundancy_dists_inv_sp)
